...
<script type="text/javascript">
	$(function(){
        ...
        Main.CountValue("total_posts_reach",data_posts_reach);
        Main.CountValue("total_posts_impressions",data_posts_impressions);
        Main.CountValue("total_posts_reach_paid",data_posts_reach_paid);
        Main.CountValue("total_posts_reach_organic",data_posts_reach_organic);
        Main.CountValue("total_posts_impressions_paid",data_posts_impressions_paid);
        Main.CountValue("total_posts_impressions_organic",data_posts_impressions_organic);

        Main.CountValue("total_link_clicks",data_link_clicks);
        Main.CountValue("total_photo_view",data_photo_view);
        Main.CountValue("total_video_play",data_video_play);
        Main.CountValue("total_other_clicks",data_other_clicks);

        Main.CountValue("total_positive_like",data_like);
        Main.CountValue("total_positive_comment",data_comment);
        Main.CountValue("total_positive_link",data_link);
        Main.CountValue("total_positive_answer",data_answer);
        Main.CountValue("total_positive_claim",data_claim);
        Main.CountValue("total_positive_rsvp",data_rsvp);

        Main.CountValue("total_unlike_page_clicks", data_unlike_page_clicks);
        Main.CountValue("total_report_spam_clicks", data_report_spam_clicks);
        Main.CountValue("total_xbutton_clicks", data_xbutton_clicks);
        Main.CountValue("total_hide_all_clicks", data_hide_all_clicks);
        Main.CountValue("total_hide_clicks", data_hide_clicks);
	});
</script>