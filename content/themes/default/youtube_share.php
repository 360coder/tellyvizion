...
<?php 
session_start();
$OAUTH2_CLIENT_ID = '1097835388951-h78rhr5jtpcc8agpmfj9jjqd0vleolle.apps.googleusercontent.com';
$OAUTH2_CLIENT_SECRET = 'WoDikiu1DPDYNccgbVTJ5qT6';
...
//    FILTER_SANITIZE_URL);
$redirect = filter_var(url().'/youtube-share', FILTER_SANITIZE_URL);
