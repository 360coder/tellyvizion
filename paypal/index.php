...
$paypal_username = 'navi.sohal162@gmail.com'; //Business Email
...
<body>
    ...
    <form action="<?php echo $paypal_link; ?>" method="post">
        ...
        <!-- Specify URLs -->
        <input type='hidden' name='cancel_return' value='http://tellyvizion.com/paypal/paypal_cancel.php'>
		<input type='hidden' name='return' value='http://tellyvizion.com/paypal/paypal_success.php'>
