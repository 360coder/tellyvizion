...
@section('content')
	...
	<div class="admin-section-title">
		<div class="row">
			<div class="col-md-12">
				<h3><i class="entypo-archive"></i> Video Categories</h3><a href="javascript:;" onclick="jQuery('#add-new').modal('show');" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add New</a>
			</div>
		</div>
	</div>
				...
				<div id="nestable" class="nested-list dd with-margins">
					...
					@foreach($video_categories as $category)
						...
						<li class="dd-item" data-id="{{ $category->id }}">
							...
							<div class="actions"><a href="{{ URL::to('') }}/admin/videos/categories/edit/{{ $category->id }}" class="edit">Edit</a> <a href="{{ URL::to('') }}/admin/videos/categories/delete/{{ $category->id }}" class="delete">Delete</a></div>
	...
	@section('javascript')
		...
		<script src="{{ URL::to('/application/assets/admin/js/jquery.nestable.js') }}"></script>
