...
class YoutubeC
{
    ...
    public function api_get($url, $params)
    {
        ...
        curl_setopt($tuCurl, CURLOPT_SSL_VERIFYPEER, false); // allow https verification if true
        curl_setopt($tuCurl, CURLOPT_SSL_VERIFYHOST, 2); // check common name and verify with host name
